...
一个出行计划工具的 demo —— 把分散在小红书收藏夹里的吃喝住行攻略，整合成一个可调整的行程时间轴。
...
这个 demo 展示了产品经理的几个关键能力：
- **需求洞察**：从真实痛点出发（收藏夹混乱、忘记拍照角度）
- **MVP 思维**：先跑通核心流程，不追求完美
- **用户体验**：拖拽排序、出片指南高亮、地图可视化
- **技术理解**：用合适的工具解决问题，不过度工程化
